...
public class MemberDAO implements MemberDAO_interface {
	...
	static {
		try {
			...
			ds = (DataSource) ctx.lookup("java:comp/env/jdbc/jdbc/eLookDB");
	...
	private static final String UPDATE_MEMBER = "update Member set email=?, mPassword=?, mName=?, mPhoto=?, skill=?, hobby=?, address=? where memberID= ?";
