			...
			<div class="col-md-4 ">
				<div class="panel panel-default text-center">
					...
					<div class="panel-body"
						style="padding: 40px; background-color: #00a8b3;">
						<a class="" href="#"> <img
							class="media-object dp img-circle center-block"
					...
					<h2
						style="background-color: #41cac0; margin-top: 0; margin-bottom: 0; padding-top: 20px; padding-bottom: 20px; color: white;">${LoginOK.mName}</h2>
				</div>
