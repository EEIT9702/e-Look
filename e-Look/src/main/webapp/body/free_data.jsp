	...
	<div class="col-md-6 col-sm-6 col-lg-4 col-xs-6" id="course" style="width:341px;margin-bottom:20px;">
		<div class="card card-inverse" >
			...
			<div class="card-footer">
				...
				<br>
				<small style="font-size: 18px;color:#f2fef1" class="" alt="${freeCourse.courseVO.courseID}">購買人數:</small>
			</div>
		</div>
	</div>
</c:forEach>
	...
	<div class="col-md-6 col-sm-6 col-lg-4 col-xs-6" id="course" style="width:341px;margin-bottom:20px;">
		<div class="card card-inverse" >
			...
			<div class="card-footer">
				...
				<br>
				<small style="font-size: 18px;color:#f2fef1;" class="number" alt="${courseVO.courseID}">購買人數:</small>
			</div>
		</div>
	</div>
</c:forEach>
