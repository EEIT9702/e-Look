...
<div class="container cbox" style="">
		<div class="row">
   			<div class="col-md-12" style="float:right;margin-bottom:30px;">
				...
				<button type="button" value="hideHistory" onclick="self.location.href='breport-course.jsp'" class="btn btn-success" style="font-size:17px;float:right;"><i class="fa fa-level-up"></i>&nbsp;回到檢舉課程管理</button>
			</div>
