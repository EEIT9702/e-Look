        ...
        <div class="footer-top2"> 
           <div class="container">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-center">
                   <a href="<%=request.getContextPath() %>/HOME.jsp"><i class="fa fa-home fa-2x"></i>home</a>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-center">
                   <a href="<%=request.getContextPath()%>/CreateCourseCotroller"><i class="fa fa-graduation-cap fa-2x"></i>我要開課</a>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-center">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-center">
                    <a href="<%=request.getContextPath()%>/member/member.jsp"><i class="fa fa-child fa-2x"></i>會員中心</a>
                </div>
           </div> 
        </div>  
