...
<!-- 預覽課程頁面圖 --><div id="course" class="list-inline pull-right">		
								<div>
									<div >
										<img id="icon" src="video/icon.png">
										<img src="Class Steps/imgs/請上傳課程封面.png" alt="course" class="picture-src" id="wizardPicturePreview" title="" style="width:298px;height:198px"/>							
									</div>
									<table>
										<tr>
											<td><font size="5px">追劇學韓文—韓語初級會話課程</font></td>
										</tr>
										<tr>
											<td style="width: 300px"><br>
											<br>
											<font size="4px">售價:</font> 
											<font size="4px"></font>
											</td>
										</tr>
										<tr>
